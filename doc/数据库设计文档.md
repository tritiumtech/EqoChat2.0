...
| 20 | i18n_text | 多语言资源 | ✅ 5个 |
| 21 | system_config | 系统配置 | ✅ 5个 |
| 22 | operation_log | 操作日志 | ✅ 5个 |
...
| locale | VARCHAR(20) | 语言偏好（如 zh-CN/en-US） |
